import <%= upCaseName %>Module from './<%= fileName %>'
import <%= upCaseName %>Controller from './<%= fileName %>.controller';
import <%= upCaseName %>Component from './<%= fileName %>.component';
import <%= upCaseName %>Template from './<%= fileName %>.html';
